...
HD_PWD='/home/haoyu/workspace/riscv/riscvBoy/fpga/example/example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SDP_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SDP_RAM.tcl
